  ...
  <dsp:droplet name="/atg/commerce/inventory/InventoryLookup">
    ...
    <dsp:oparam name="output">
        ...
        <dsp:droplet name="IsEmpty">
          <dsp:param name="value" param="item.auxiliaryData.catalogRef.displayName"/>
          <dsp:oparam name="false">
            <dsp:a page="item.auxiliaryData.productRef.template.url">
              <dsp:param name="id" param="item.auxiliaryData.productRef.repositoryId"/>
              <dsp:param name="navAction" value="jump"/>
              <dsp:droplet name="IsEmpty">
                <dsp:param name="value" value="item.auxiliaryData.productRef.template.url"/>
                <dsp:oparam name="false">
                  <%= displayName %>
                </dsp:oparam>
          ...
          <dsp:oparam name="true">
            <%-- The productRef or template url is missing, so we can't generate an anchor tag. --%>
              <dsp:droplet name="IsEmpty">
                <dsp:param name="value" value="item.auxiliaryData.catalogRef.displayName"/>
                <dsp:oparam name="false">
                  <%= displayName %>
                </dsp:oparam>
                <dsp:oparam name="true">
