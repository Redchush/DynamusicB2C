    ...
    <tr>
      ...
      <td class="body">
        ...
        <dsp:droplet name="/atg/dynamo/droplet/Switch">
          ...
          <dsp:oparam name="true">
            ...
            <dsp:droplet name="/atg/dynamo/droplet/ErrorMessageForEach">
              <dsp:param bean="ExpressCheckoutFormHandler.formExceptions"
                         name="exceptions"/>
        ...
        <dsp:form action="purchaseinfo.jsp" method="post">
          ...
          <dsp:input bean="ExpressCheckoutFormHandler.paymentGroupNeeded" value="false" type="hidden"/>
          <dsp:input bean="ExpressCheckoutFormHandler.shippingGroupNeeded" value="false" type="hidden"/>
          <dsp:input bean="ExpressCheckoutFormHandler.expressCheckoutSuccessURL" value="orderconfirm.jsp" type="hidden"/>
          ...
          <div class="sh_info_box">
            <div class="gr_header">Shipping Information</div>
              <%-- Chapter 8, Ex. 1, Step 2: Insert Name and address information here --%>
            <b>First Name: </b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.firstName"
                       type="text" beanvalue="Profile.shippingAddress.firstName" size="30"/>
            <br>
            <b>Middle Name:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.middleName"
                       type="text" beanvalue="Profile.shippingAddress.middleName" size="30"/>
            <br>
            <b>Last Name:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.lastName"
                       type="text" beanvalue="Profile.shippingAddress.lastName" size="30"/>
            <br>
            <b>Address 1:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.address1"
                       type="text" beanvalue="Profile.shippingAddress.address1" size="30"/>
            <br>
            <b>Address 2:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.address2"
                       type="text" beanvalue="Profile.shippingAddress.address2" size="30"/>
            <br>
            <b>City:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.city"
                       type="text" beanvalue="Profile.shippingAddress.city" size="30"/>
            <br>
            <b>State:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.state"
                       type="text" beanvalue="Profile.shippingAddress.state" size="30"/>
            <br>
            <b>Postal Code:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.postalCode"
                       type="text" beanvalue="Profile.shippingAddress.postalCode" size="30"/>
            <br>
            <b>Country:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.country"
                       type="text" beanvalue="Profile.shippingAddress.country" size="30"/>
            <br>
            <b>Email:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.email"
                       type="text" beanvalue="Profile.email" size="30"/>
            <br>
            <b>Phone:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.phoneNumber"
          ...
          <div class="bill_info_box">
            ...
            <b>First Name:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.firstName"
                       beanvalue="Profile.firstName" size="30" type="text" required="true>"/><br>
            <b>Middle Name:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.middleName"
                       beanvalue="Profile.middleName" size="30" type="text"/><br>
            <b>Last Name:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.lastName"
                       beanvalue="Profile.lastName" size="30" type="text" required="true"/><br>
            <b>Address 1:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.address1"
                       beanvalue="Profile.billingAddress.address1" size="30" type="text"/><br>
            <b>Address 2:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.address2"
                       beanvalue="Profile.billingAddress.address2" size="30" type="text"/><br>
            <b>City:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.city"
                       beanvalue="Profile.billingAddress.city" size="30" type="text" required="true"/><br>
            <b>State:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.state" maxsize="2"
                       beanvalue="Profile.billingAddress.state" size="2" type="text" required="true"/><br>
            <b>Postal Code:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.postalCode"
                       beanvalue="Profile.billingAddress.postalCode" size="10" type="text" required="true"/><br>
            <b>Country:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.country"
          ...
          <div class="cc_type box">
            ...
            <b>Number:</b>
            <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.creditCardNumber"
